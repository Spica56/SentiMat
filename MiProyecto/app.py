...
@app.route('/metematica_multiplicaciones')
def mate_mu():
    return render_template('mate_ej_m.html') 
...
@app.route('/emociones')
def emociones():
    return render_template('1emocion.html')

#test emociones
@app.route('/testemociones')
def test():
    return render_template('test_e.html')

@app.route('/respuesta')
def respu():
    return render_template('respu.html')
